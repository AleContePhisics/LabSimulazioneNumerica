...
private:
  ...
  vector<double> avgU;   // Vector of U/N to evaluate autocorrelation
  vector<int> gofr;
...
public: // Function declarations
  ...
  void AutoCorrelation(int _nblock,int blk,vector<double>&X);     //perform the autocorrelation vector
  void Reset();               // reset all the vector in System
  double StatisticUncertainties(int L,int N);

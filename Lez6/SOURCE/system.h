...
public: // Function declarations
  ...
  void Reset();               // Reset all vectors in System
  void SetTemp(double T);     // Change the value of T and beta
  void SetSymType(int x);     // Change the value of the simulation (ising,ecc)
  void SetH(double H);
};
